...
- **[MQTT sources](https://bsure-analytics.github.io/flechtwerk/guides/mqtt/)** — push-driven extractors that ACK to the broker only once a batch is durable in Kafka.
